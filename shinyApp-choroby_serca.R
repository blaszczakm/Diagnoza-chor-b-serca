...
menu<-dashboardSidebar(sidebarMenu(
  ...
  menuItem("Diagnose yourself",
           ...
           menuSubItem("Prediction", "diagnoza"))
))
...
body<-dashboardBody(tabItems(
  ...
  tabItem("pytania",
          ...
          fluidRow(
            ...
            column(width = 4,
                          sliderInput("my_age", "Question 1 (wait for update)",
                                      min=0,max = 1,value = 0),
                          
                          sliderInput("my_sex", "Question 2 (wait for update)",
                                      min = 0, max = 1,value = 0),
                          
                          sliderInput("my_cp", "Question 3 (wait for update)",
                                      min = 0, max = 1,value = 0 ),
                          
                          sliderInput("my_trestbps", "Question 4 (wait for update)",
                                      min = 0, max = 1,value = 0)
            ),
            
            column(width = 4,
                   
                   sliderInput("my_chol","Question 5 (wait for update)",
                               min = 0, max = 1, value = 0),
                   
                   sliderInput("my_thalach", "Question 6 (wait for update)",
                               min = 0, max = 1,value = 0),
                   
                   sliderInput("my_fbs", "Question 7 (wait for update)",
                               min = 0, max = 1,value = 0),
                   
                   sliderInput("my_restecg", "Question 8 (wait for update)",
                               min = 0, max = 1,value = 0),
                   
                   sliderInput("my_exang", "Question 9 (wait for update)",
                               min = 0, max = 1,value = 0)
            ),
            
            column(width = 4,
                   
                   sliderInput("my_oldpeak", "Question 10 (wait for update)",
                               min = 0, max = 1.1, value = 0),
                   
                   sliderInput("my_slope", "Question 11 (wait for update)",
                               min = 0, max = 1, value = 0),
                   
                   sliderInput("my_ca", "Question 12 (wait for update)",
                               min = 0, max = 1, value = 0),
                   
                   sliderInput("my_thal", "Question 13 (wait for update)",
                               min = 0, max = 1, value = 0)
            )
          )
...
server<-function(input, output, session){
  ...
  output$wyjasnienie <- renderText({
    ...
    ### aktualizowanie widgetow ###
    
    
    updateSliderInput(session, "my_age", "Your age: ",
                min=1,max = 120,step = 1, value = 28)
    
    updateSliderInput(session, "my_sex", "Sex (0-female, 1-male)",
                min = 0, max = 1, value = 0, step = 1)
    
      updateSliderInput(session, "my_cp", "Your cp:",
     ...
     updateSliderInput(session, "my_trestbps", "Your trestbps:",
      ...
      updateSliderInput(session,"my_slope", "Your slope type:",
        ...
        updateSliderInput(session,"my_ca", "Your ca value:",
        ...
        updateSliderInput(session, "my_thal", "Your thal value",
        ...
        odp<-c(age,sex,cp,trestbps,chol,fbs,restecg,thalach,exang,
